...
public class AutoFillAspect {
    ...
    public void autoFillPointCut(){} // 只是用来定义切点，标记了哪些方法需要被拦截
    ...
    public void autoFill(JoinPoint joinPoint){
        ...
        MethodSignature signature =
                (MethodSignature) joinPoint.getSignature();//方法签名对象
        AutoFill autoFill =
                signature.getMethod().getAnnotation(AutoFill.class);//获取方法上的注解对象
